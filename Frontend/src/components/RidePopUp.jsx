            ...
            <div className="flex gap-2 justify-between flex-col items-center">
                ...
                <div className="mt-5 w-full">
                    <button
                        ...
                        className="w-full mt-5 flex justify-center bg-gray-300 text-gray-700 font-semibold p-3 px-10 rounded-lg"
                    >
                        Ignore
                    </button>
                    <button
                        ...
                        className="w-full mt-2 bg-green-600 text-white font-semibold p-3 px-10 rounded-lg"
                    >
                        Accept
                    </button>
                </div>
